...
class sDOS_Adafruit_ST7735_Shim : public Adafruit_ST7735 {
    public:
        sDOS_Adafruit_ST7735_Shim(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk, int8_t rst = -1) : Adafruit_ST7735(cs, dc, mosi, sclk, rst) {};
        sDOS_Adafruit_ST7735_Shim(int8_t cs, int8_t dc, int8_t rst) : Adafruit_ST7735(cs, dc, rst) {};
        #if !defined(ESP8266)
        sDOS_Adafruit_ST7735_Shim(SPIClass *spiClass, int8_t cs, int8_t dc, int8_t rst) : Adafruit_ST7735(spiClass, cs, dc, rst) {};
        #endif // end !ESP8266
